...
async def _smoke_test():
    ...
    state = AgentState(run_id="test_budget_run")

    # 1. 模拟未超标放行 (消耗 500 Token)
    ...
    print("1. 未达警戒线正常放行通过 (500/1000)")

    # 2. 模拟达到警戒线预警 (消耗 850 Token)
    ...
    print(f"3. 触碰硬上限强制熔断通过: {state.last_error}")

    print("context/budget.py 冒烟自测全部通过！")
